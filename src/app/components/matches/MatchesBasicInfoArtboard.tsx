...
import basicInfoArtboard from '../../../assets/matches-artboard-basicinfo.png';

/** Artboard: matches-artboard-basicinfo.png (427×402). Overlays are % of rendered image box. */
const SLOT = {
